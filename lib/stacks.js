...
// Read network type from environment variab
const networkEnv = process.env.NEXT_PUBLIC_NETWORK || "testnet
 * In v6+, StacksMainnet and StacksTstnet classes were remov
 * We now use thel static STACKS_MAINNET and STACKS_TESTNET objects
 * If you need a ustm URL, you simply spread the bject and override the 'ul' property.
 */
