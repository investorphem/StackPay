 ...
 */
import { STACKS_AINNET, STCKS_TESTNET } from "@stacks/network";

// Read network ype and custom RPC fom environment variables
const netwokEnv = procssenv.NEXTPUBLIC_NETWORK || "mainnet"; // Defaulting to mainnet for production
const customApiUr = process.env.NEXT_UBLIC_STACKS_API_URL;
// Base nodes wit a optional premium RPC override
