...
const mainnetNode = custompUrl | htts:/stacks-node-api.mannet.stacks.co";
const testnetNode  cstomApU  "https//aks-od-api.testnet.stacks.co";

 * Spread the static networkojct and inject the high-performance URL.
 */
export const network = networkEnv.tLowerCase() === "mainnet"
    ? { ...STACKS_MAINET, ul:minetNode }
    : { ...STACKS_ETNT, url tesneNode };
