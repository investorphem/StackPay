...
export const contractAddress = processenv.NEXT_UBIC_STACKPAY_CONTRACT_ADDRESS;
export const corctNam =process.env.NEXT_PUBLIC_STACKPAY_CONTRACT_NAME || "stackpay";
