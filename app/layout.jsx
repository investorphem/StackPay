...
export const metadata = {
  ...
  openGraph: {
    title: "StackPay | Premium STX Payroll",
    description: "Real-time decentralized payroll and streaming on the Stacks blockchain.",
    url: "https://stackpay-one.vercel.app", // FIX: Removed trailing slash to match metadataBase perfectly
    siteName: "StackPay",
    images: [
      { 
        // FIX: Hardcoded absolute URL. WhatsApp specifically demands this to render the image.
        url: "https://stackpay-one.vercel.app/og-image.png", 
        width: 1200, 
        height: 630, 
        alt: "StackPay Protocol" 
      }
    ],
    locale: "en_US",
    type: "website",
  ...
  twitter: {
    ...
    title: "StackPay | Premium STX Payroll",
    description: "Real-time decentralized payroll and streaming on the Stacks blockchain.",
    // FIX: Hardcoded absolute URL for Twitter as well
    images: ["https://stackpay-one.vercel.app/og-image.png"],
  },
  other: {
...
export default function RootLayout({ children }) {
  return (
    // Removed hardcoded className="dark" so the ThemeToggle can actually control it.
    // Added suppressHydrationWarning to prevent React errors when injecting the theme client-side.
    <html lang="en" suppressHydrationWarning>
      {/* Added base light/dark colors to the body */}
      <body className={`${inter.className} antialiased selection:bg-purple-500/30 bg-white dark:bg-gray-950 transition-colors duration-300`}>
          ...
          <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            ...
            <Link href="/" className="flex items-center gap-3 group hover:opacity-80 transition-opacity">
              ...
              <div className="hidden sm:block">
                {/* Text flips to dark gray in light mode, white in dark mode */}
        ...
        {/* Footer */}
        {/* Added light mode backgrounds and borders to the footer */}
