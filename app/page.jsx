    ...
    <div className="relative overflow-hidden bg-gray-950 min-h-[calc(100vh-80px)] flex flex-col items-center justify-center px-6">
      ...
      <div className="max-w-4xl w-full text-center z-10">
        ...
        >
          ...
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-indigo-400 to-purple-600">
            Secured by Bitcoin
          </span>
        </motion.h1>
        ...
        <motion.div 
          ...
          className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-24 text-left border-t border-gray-900 pt-12"
        >
          <div className="space-y-3">
            ...
            <p className="text-sm text-gray-500 leading-relaxed">Funds settle automatically on-chain with every Stacks block confirmation.</p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <h4 className="font-bold text-white">Trustless Escrow</h4>
            <p className="text-sm text-gray-500 leading-relaxed">Clarity smart contracts ensure employers and employees are always protected.</p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <h4 className="font-bold text-white">Bitcoin Security</h4>
            <p className="text-sm text-gray-500 leading-relaxed">Leverages the Stacks PoX consensus to inherit the security of the Bitcoin network.</p>
          </div>
        </motion.div>
      </div>
    </div>
