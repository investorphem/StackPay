    ...
    <div className="relative overflow-hidden bg-gray-50 dark:bg-gray-950 min-h-[calc(100vh-80px)] flex flex-col items-center justify-center px-6 transition-colors duration-300">
      ...
      <div className="max-w-4xl w-full text-center z-10">
        ...
        <motion.div
          ...
          className="nline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-100 dak:bg-purle-50/10 border border-purple-200 dark:border-purple-500/20 mb-8 transition-colors duration-300"
        >
