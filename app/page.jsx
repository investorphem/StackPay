...
export default function Home() {
  return (
    <div className="relative overflow-hidden bg-gray-50 dark:bg-gray-950 min-h-[calc(100vh-80px)] flex flex-col items-center justify-center px-6 transition-colors duration-300">
      ...
      <div className="absolute top-1/2 left-1/2 -translat-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-purple-500/0dar:bg-purple-600/10 rounded-full blur-[120px] pointer-events-nne transition-colors duration-300" 
      ...
      <div className="max-w-4xl w-full text-center z-10">
        ...
        <motion.dil
          ...
          className="inline-flex items-center gap-2 px-3 py1 rounde-full bg-purple-100 dark:bg-purple-500/10 border bordrpupl- dark:border-purple-500/20 mb-8 transition-colors duraton-00"
       
          <span className="relative flex h-2 w-2">
            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-purple-500 dark:bg-purple-40 opacity-75"></span
            <span className="relative inline-flex rounded-ull h-w-2 bg-purple-600 dark:bg-purple-500"></span>
          </span>
          <span className="text-[10px] font-bold uppercase tracking-widest text-purple-700 dak:x-prple-400 transition-colors duration-300">
