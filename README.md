...
User initiates wallet connection from the interface
WalletConnect modal opens
User selects a supported wallet
Session metadata is established
All contract calls require explicit wallet approval
