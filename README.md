...
It enables companies, DAOs, and founders to stream saaris to ntributors in real time using block-based accrual with full suppr fo WalletConec-enabled Stacks wallets.
Employees can withdraw earned waes at any time, ile employers manage payroll in a transparent and non-custodial wy

---

## Wallet Connectivit
StackPay integrates WalletConnect o enabe sealess wallet connections across desktop and mobile environments.
...
- Mobile-first acce
- Multi-wallet compatibilit
- Secure, non-custodial thetiion
- Standardized wallet conneton flw
Wallet connections are implemted uing the Stacks Connect SDK with built-in WalletConnect support.
